...
//     <div className="mb-4">
//       <label className="block mb-1 font-bold text-pink-500 text-sm ps-5" htmlFor="cash">
//         Cash:
//       </label>
...
//     <div className="mb-4">
//       <label className="block mb-1 font-bold text-pink-500 text-sm ps-5" htmlFor="upi">
//         UPI:
//       </label>
//       <div className="flex gap-3 items-center">
...
//     <div className="mb-4">
//       <label className="block mb-1 font-bold text-pink-500 text-sm ps-5" htmlFor="credit">
//         Credit:
//       </label>
//       <div className="flex gap-3 items-center">
...
const PaymentDetails = ({ cash, setCash, upi, setUpi, credit, setCredit, handleDoubleClick }) => (
  <div className="flex flex-col md:flex-row justify-around mb-4 gap-4">
    <div className="w-full md:w-1/3">
      <label className="block mb-1 font-bold text-pink-500 text-sm" htmlFor="cash">
        Cash:
      </label>
      <div className="flex gap-3 items-center">
        <span className="text-3xl cursor-pointer" onDoubleClick={() => handleDoubleClick("cash")}>
    ...
    <div className="w-full md:w-1/3">
      <label className="block mb-1 font-bold text-pink-500 text-sm" htmlFor="upi">
        UPI:
      </label>
      <div className="flex gap-3 items-center">
        <span className="text-3xl cursor-pointer" onDoubleClick={() => handleDoubleClick("upi")}>
    ...
    <div className="w-full md:w-1/3">
      <label className="block mb-1 font-bold text-pink-500 text-sm" htmlFor="credit">
        Credit:
      </label>
      <div className="flex gap-3 items-center">
        <span className="text-3xl cursor-pointer" onDoubleClick={() => handleDoubleClick("credit")}>
