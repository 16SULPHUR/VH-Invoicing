...
const UpdatedVarietyHeavenInvoice = ({ 
  customerName, 
  customerContact,
  invoiceId,
  invoiceDate,
        ...
        <div style={styles.container}>
            <div style={styles.header}>
                <div>
                    ...
                    <p style={styles.companyDetails}>Shop no. 09, Sentosa Enclave, Near Ramipark soc.,</p>
                ...
                <img src="https://ik.imagekit.io/dqn1rnabh/logo-vh.png?updatedAt=1726645373505" alt="Variety Heaven Logo" style={styles.logo} />
            </div>
            ...
            <div style={{...styles.section, display: 'flex', justifyContent: 'space-between'}}>
                ...
                <div style={{border: '1px solid #000', padding: '2mm', width: '48%'}}>
                    <p style={{ margin: '1mm 0' }}><strong>Invoice No:</strong> {invoiceId}</p>
                    <p style={{ margin: '1mm 0' }}><strong>Date:</strong> {invoiceDate}</p>
                </div>
            </div>
            ...
            <table style={styles.table}>
                ...
                <tfoot>
                    <tr>
                        ...
                        <td style={{...styles.td, fontWeight: 'bold'}}>{formatCurrency(grandTotal)}</td>
                    </tr>
                </tfoot>
            </table>
            ...
            <div style={styles.footer}>
                <div style={{ width: '48%', border: '1px solid #000', padding: '2mm' }}>
                    <h3 style={{ margin: '0 0 2mm 0', fontSize: '18px' }}>Amount in words:</h3>
                    <p style={{ margin: '0', fontSize: '16px', fontWeight: 'bold' }}>{}</p>
                </div>
                <div style={{ width: '48%', textAlign: 'center', border: '1px solid #000', padding: '2mm' }}>
                    <p style={{ marginTop: '15mm', borderTop: '1px solid #000', paddingTop: '2mm', fontSize: '16px' }}>Company seal and Sign</p>
                </div>
            </div>
        </div>
    );
