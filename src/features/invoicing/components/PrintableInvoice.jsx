...
export const PrintableInvoice = ({
  ...
  const upiLink = upiLinkFor(grandTotal);
  ...
  return (
    <div style={styles.container} className="vh-invoice-print-friendly">
      {/* Inlined rather than injected: this component is also rendered to a
          static string for the print window, where effects never run. */}
      ...
      <div style={styles.header}>
        <div>
          ...
          <p style={styles.companyDetails}>
            Shop no. 09, Sentosa Enclave, Near Ramipark soc., Dindoli, Surat, Gujarat. PIN: 394-210
          </p>
