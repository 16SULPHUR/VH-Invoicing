  ...
  return (
    <div className="flex font-sans w-full h-full mx-auto py-12 bg-zinc-800">
      ...
      <div className="w-[400px] h-[90vh] overflow-y-scroll rounded-md px-2">
        ...
        <div>
          <h3 className="text-lg font-bold text-sky-500 mb-2.5">
            Sales Information
          </h3>
          ...
          <div className="mb-5 bg-white rounded-md shadow-md p-4">
            ...
            {salesType === "custom" && (
              <div className="mt-4">
                ...
                />
                <label
                  className="block mt-4 mb-1 text-sm text-gray-700"
                  htmlFor="end"
                >
                  End Date:
                </label>
      ...
      <div className="flex-grow border p-3">
        ...
        <table className="w-full border-collapse mb-5">
          <thead>
            <tr>
              <th className="bg-sky-500 text-white border border-black p-2.5 text-left">
                Item Name
              </th>
              <th className="bg-sky-500 text-white border border-black p-2.5 text-left">
                Quantity
        ...
        <div>
          <div className="flex justify-around">
            <div className="mb-4">
              <label
                className="block mb-1 font-bold text-sky-500 text-sm ps-5"
                htmlFor="cash"
              >
                Cash:
              </label>
        ...
        <div className="mt-5 text-right">
          <button
            ...
            }-500 text-white px-4 py-2 rounded-md cursor-pointer`}
      ...
      <div className="w-[300px] h-[90vh] overflow-y-scroll p-3 text-sky-200 rounded-md">
        ...
        {recentInvoices.map((invoice) => {
          ...
          return (
            ...
            >
              <p className="text-md font-bold border-b">
